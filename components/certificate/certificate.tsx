    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md w-full mx-4 transform transition-all animate-bounce-once">
        <div className="text-center">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white">certificate Generated Successfully!</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6 sm:p-8">
              ...
              <form onSubmit={generatecertificate} className="space-y-4 sm:space-y-6">
                {/* Name Input */}
                <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/50 rounded-lg">
                  ...
                  <ul className="mt-2 text-sm text-blue-700 dark:text-blue-200 list-disc list-inside">
                    <li>Please keep your certificate safe</li>
                    <li>certificate is non-transferable</li>
                    <li>Show your ID along with the certificate</li>
                  </ul>
                </div>
                <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
                  <p className="text-gray-600 dark:text-gray-400">
                    Need help? Contact event support at <a href="mailto:linpack@vitbhopal.ac.in" className="text-blue-600 dark:text-blue-400">linpack@vitbhopal.ac.in</a>
                  </p>
                </div>
              </div>
            </div>
